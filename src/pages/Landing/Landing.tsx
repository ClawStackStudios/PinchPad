      ...
      <div className="w-full max-w-7xl mx-auto px-4 py-24 border-t border-slate-200 dark:border-slate-800">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto">
            PinchPad isn't just a notepad. It's a sovereign data vault built for the modern web, designed to protect your ideas from prying eyes while allowing you to delegate access to autonomous agents.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white dark:bg-[#151b23] p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xl hover:shadow-2xl transition-shadow">
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              No passwords. No emails. Your identity is a cryptographic <code className="text-cyan-500 bg-cyan-500/10 px-1.5 py-0.5 rounded font-mono text-sm">hu-</code> key generated entirely on your device. Your claws hold the only keys to your vault.
            </p>
          </div>
