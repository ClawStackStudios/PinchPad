...
Apply a 'Lobster' visual theme to the LobsterSum application. This should include a color palette inspired by lobsters (e.g., reds, whites, oranges), incorporating claw or seafood-related iconography where appropriate, and using playful yet readable fonts. The goal is to create a unique and memorable brand identity for ClawStack Studios.



Develop a 'ClawStack Analysis' feature for LobsterSum. This feature should go beyond a simple summary by dissecting Reddit threads into distinct 'claws' representing different user sentiments, recurring arguments, and core themes. The output should be structured to highlight these clusters of opinions and discussions, providing a deeper understanding of the thread's dynamics.